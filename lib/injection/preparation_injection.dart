...
import 'package:asset_management/domain/usecases/preparation/find_preparation_by_code_or_destination_use_case.dart';
...
preparationInjection(GetIt locator) {
  ...
  locator.registerLazySingleton(
    () => FindPreparationByCodeOrDestinationUseCase(locator()),
  );
