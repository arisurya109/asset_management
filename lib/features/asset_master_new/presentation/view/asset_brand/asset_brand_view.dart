...
import 'create_asset_brand_view.dart';
          ...
          body: Padding(
            ...
            child: BlocBuilder<AssetBrandBloc, AssetBrandState>(
              builder: (context, state) {
                ...
                if (state.assetBrands == null || state.assetBrands!.isEmpty) {
                  return Center(
                    child: Text(
                      state.message ?? '',
                ...
                return ListView.builder(
                  ...
                  itemCount: state.assetBrands?.length,
                  itemBuilder: (context, index) {
                    final asset = state.assetBrands![index];
                    return Padding(
