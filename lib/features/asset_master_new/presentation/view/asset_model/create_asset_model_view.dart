              ...
              BlocBuilder<AssetTypeBloc, AssetTypeState>(
                builder: (context, state) {
                  return AppDropDown(
                    ...
                    title: 'Type',
                    value: assetType,
                    items: state.assetTypes?.map((e) => e.name).toList(),
                    onSelected: (value) => setState(() {
                      assetType = value;
                      assetTypeId = state.assetTypes
              ...
              BlocBuilder<AssetCategoryBloc, AssetCategoryState>(
                builder: (context, state) {
                  return AppDropDown(
                    ...
                    title: 'Category',
                    value: assetCategory,
                    items: state.assetCategories?.map((e) => e.name).toList(),
                    onSelected: (value) => setState(() {
                      assetCategory = value;
                      assetCategoryId = state.assetCategories
                          ?.singleWhere(
              ...
              BlocBuilder<AssetBrandBloc, AssetBrandState>(
                builder: (context, state) {
                  return AppDropDown(
                    ...
                    title: 'Brand',
                    value: assetBrand,
                    items: state.assetBrands?.map((e) => e.name).toList(),
                    onSelected: (value) => setState(() {
                      assetBrand = value;
                      assetBrandId = state.assetBrands
