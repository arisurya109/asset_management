...
class PreparationTemplateModel extends Equatable {
  ...
  factory PreparationTemplateModel.fromJson(Map<String, dynamic> map) {
    return PreparationTemplateModel(
      id: map['id'] != null ? map['id'] as int : null,
      templateCode: map['template_code'] != null
          ? map['template_code'] as String
          : null,
      ...
      description: map['description'] != null
          ...
          : null,
      createdById: map['created_by_id'] != null
          ? map['created_by_id'] as int
          : null,
      ...
      items: map['items'] != null
          ? List<PreparationTemplateItemModel>.from(
              (map['items'] as List).map<PreparationTemplateItemModel?>(
                (x) => PreparationTemplateItemModel.fromJson(
  ...
  factory PreparationTemplateModel.fromEntity(PreparationTemplate params) {
    return PreparationTemplateModel(
      ...
      items: params.items
          ?.map(PreparationTemplateItemModel.fromEntity)
          .toList(),
      name: params.name,
