...
import 'package:asset_management/mobile/presentation/view/preparation_set/create_preparation_template_view.dart';
import 'package:asset_management/mobile/presentation/view/preparation_set/preparation_template_detail_view.dart';
          ...
          appBar: AppBar(
            ...
            actions: permission?.contains('master_add') == true
                ? [
                    IconButton(
                      onPressed: () =>
                          context.pushExt(CreatePreparationTemplateView()),
                      icon: Icon(Icons.add),
                    ),
                  ]
                : null,
