...
import 'package:asset_management/mobile/presentation/view/vendor/create_vendor_view.dart';
import 'package:asset_management/mobile/presentation/view/vendor/vendor_detail_view.dart';
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            actions: permission?.contains('master_add') == true
                ? [
                    IconButton(
                      onPressed: () => context.pushExt(CreateVendorView()),
                      icon: Icon(Icons.add),
                    ),
                  ]
                : null,
