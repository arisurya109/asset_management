...
import 'package:asset_management/presentation/view/user_management/create_user_view.dart';
import 'package:asset_management/presentation/view/user_management/user_detail_view.dart';
                ...
                if (state.users != null) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        onTap: () {
                          context.push(UserDetailView(params: user!));
                        },
