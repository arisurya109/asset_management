...
class DataSourcePreparationDetail extends DataTableSource {
  final List<PreparationDetail?> data;
  void Function(String asset, int modelId, int quantity)? onTap;

  DataSourcePreparationDetail(this.data, this.onTap);
  ...
  DataRow? getRow(int index) {
    ...
    return DataRow2(
      ...
      cells: [
        ...
        DataCell(Center(child: Text(item.quantityTarget.toString()))),
        DataCell(Center(child: Text(item.quantityPicked.toString()))),
